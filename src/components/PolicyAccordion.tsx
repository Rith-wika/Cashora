    ...
    content: (
      <div className="space-y-4 text-sm text-muted-foreground">
        <ol className="list-decimal pl-5 space-y-3">
          ...
          <li>The Platform is owned by 9701314138, a company incorporated under the Companies Act, 1956 with its registered office at Miyapur (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</li>
    ...
    content: (
      <div className="space-y-4 text-sm text-muted-foreground">
        ...
        <ol className="list-decimal pl-5 space-y-3">
          ...
          <li>9701314138 does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
          ...
          <li>In case of any refunds approved by 9701314138, it will take 7 days for the refund to be processed to you.</li>
        </ol>
      </div>
    ),
  },
