...
export const policyData: Policy[] = [
    {
        ...
        description: 'Read our terms and conditions regarding the use of our platform.',
        content: (
            <div className="space-y-4 text-foreground">
                <ol className="list-decimal pl-5 space-y-3">
                    ...
                    <li>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name www.sriainfotech.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</li>
                    <li>The Platform is owned by <b>9701314138</b>, a company incorporated under the Companies Act, 1956 with its registered office at <b>Miyapur</b> (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').</li>
                    ...
                    <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Telangana.</li>
    ...
    },
    {
        ...
        content: (
            <div className="space-y-4 text-foreground">
                ...
                <h4 className="font-semibold text-foreground">Disclosure of Personal Data</h4>
                ...
                <h4 className="font-semibold text-foreground">Security Precautions</h4>
                ...
                <h4 className="font-semibold text-foreground">Data Deletion and Retention</h4>
                ...
                <h4 className="font-semibold text-foreground">Changes to this Privacy Policy</h4>
    ...
    },
    {
        ...
        description: 'Details about our refund and cancellation policies.',
        content: (
            <div className="space-y-4 text-foreground">
                ...
                <ol className="list-decimal pl-5 space-y-3">
                    <li>Cancellations will only be considered if the request is made within <b>7 days</b> of placing the order. However, cancellation requests may not be entertained if the orders have been communicated to such sellers / merchant(s) listed on the Platform and they have initiated the process of shipping them, or the product is out for delivery. In such an event, you may choose to reject the product at the doorstep.</li>
                    <li><b>9701314138</b> does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
                    <li>In case of receipt of damaged or defective items, please report to our customer service team. The request would be entertained once the seller/ merchant listed on the Platform, has checked and determined the same at its own end. This should be reported within <b>7 days</b> of receipt of products. In case you feel that the product received is not as shown on the site or as per your expectations, you must bring it to the notice of our customer service within <b>7 days</b> of receiving the product. The customer service team after looking into your complaint will take an appropriate decision.</li>
                    ...
                    <li>In case of any refunds approved by <b>9701314138</b>, it will take <b>7 days</b>  for the refund to be processed to you.</li>
                </ol>
            </div>
        ),
    },
    {
        id: 'return-policy',
        title: 'Return Policy',
        description: 'Information regarding the return of products.',
        content: (
            <div className="space-y-4 text-foreground">
                <p>We offer refund / exchange within first <b>7 days</b> from the date of your purchase. If <b>7 days</b>  have passed since your purchase, you will not be offered a return, exchange or refund of any kind. In order to become eligible for a return or an exchange, (i) the purchased item should be unused and in the same condition as you received it, (ii) the item must have original packaging, (iii) if the item that you purchased on a sale, then the item may not be eligible for a return / exchange. Further, only such items are replaced by us (based on an exchange request), if such items are found defective or damaged.</p>
